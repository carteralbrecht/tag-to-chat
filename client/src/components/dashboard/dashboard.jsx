...
class Dashboard extends Component {
  constructor(props) {
    ...
    this.handleDeleteVerification = this.handleDeleteVerification.bind(this);
    this.handleDeleteVerificationClose = this.handleDeleteVerificationClose.bind(this);
  }
  ...
  // actions to open and close the are you sure
  handleDeleteVerification = () => this.setState({deleteVerifyOpen: true});
  handleDeleteVerificationClose = () => this.setState({deleteVerifyOpen: false});
  ...
  render() {
    ...
    return (
      <MuiThemeProvider theme={pageTheme}>
        ...
        <Dialog id="delete-confirmation" open={this.state.deleteVerifyOpen} onClose={this.handleDeleteVerificationClose}>
        <DialogTitle>
